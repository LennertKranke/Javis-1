...
3. **Alles Uebrige ist kein Bauauftrag.** Neue Bereiche -- Dienste, Modelle,
   ...
   Marke im Blatt.
4. **SPEC-3 ist wieder auf Stand.** Der Nachtrag aus `SPEC-3-NACHTRAG.md`
   wurde am 2026-09-01 nach ausdruecklicher Freigabe des Nutzers als
   Fassung 3.2 eingetragen: OD-4 steht dort als ENTSCHIEDEN, Abschnitt 12
   beschreibt die vier Anzeigen. Der Nachtrag bleibt als Nachweis des
   Vorschlags liegen; verbindlich ist SPEC-3.
